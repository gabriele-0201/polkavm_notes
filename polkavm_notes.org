...
1. `Compiler::new(instructions, exports, debug_trace_execution)`
...
2. and then those BOH things:
   ...
   `forward_declare_label` :: this method just create a `Label` whith `usize::MAX` (a label is a transparent wrapper to usize)
